...
namespace markov_decision_making
{
  ...
  class ControllerPOMDP: public ControlLayerBase
  {
    ...
    protected:
       ...
       */
      void act (const Index observation);
       ...
       */
      virtual void observationCallback (const ObservationInfoConstPtr& msg) = 0;
